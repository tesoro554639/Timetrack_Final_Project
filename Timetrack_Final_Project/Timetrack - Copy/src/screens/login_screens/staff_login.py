# screens/login_screens/staff_login.py
import sys
...
class StaffLoginScreen(QWidget):
    login_successful = pyqtSignal()

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle("TimeTrack - Staff Login")
        ...
        container = QFrame()
        container.setStyleSheet("")  # Remove glass effect, no background or border
    ...
    def create_header(self):
        ...
        header_frame.setStyleSheet("QFrame { background-color: transparent; border-top-left-radius: 20px; border-top-right-radius: 20px; border-bottom-left-radius: 0px; border-bottom-right-radius: 0px; }")
        ...
        subtitle1_label = QLabel("Login to access staff management dashboard")
        subtitle1_label.setFont(QFont("Inter", 9))
        subtitle1_label.setAlignment(Qt.AlignmentFlag.AlignHCenter)
        subtitle1_label.setStyleSheet("color: #fff; background-color: transparent; margin-bottom: 2px;")

        header_layout.addWidget(logo_label)
        header_layout.addSpacing(32)
        header_layout.addWidget(title_label)
        header_layout.addWidget(subtitle1_label)
    ...
    def create_content(self):
        ...
        username_label = QLabel("Staff Username")
        ...
        self.username_input.setStyleSheet("""
            ...
            QLineEdit:focus {
                border: 2px solid #a78bfa; /* pale purple */
    ...
    def handle_login(self):
        ...
        if authenticate_user(username, password, 'Staff'):
